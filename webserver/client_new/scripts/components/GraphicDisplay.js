...
define([
    ...
    Graph.prototype.drawGraph = function() {
        ...
        this.ctx.strokeStyle = (this.themeWhite? "#edeef0" : "#edeef0");
    ...
    Graph.prototype.drawAxes = function() {
        ...
        this.ctx.fillStyle = (this.themeWhite? "#edeef0" : "#edeef0");
    ...
    Graph.prototype.drawGameData = function() {
        ...
        if(Engine.gameState === 'IN_PROGRESS'|| Engine.cashingOut) {
            ...
            if (StateLib.currentlyPlaying(Engine)){
                ...
                $('.winner')[0].innerHTML = "Winner at "+parseFloat(this.currentGamePayout).toFixed(2)+"x / " + parseInt(po * StateLib.currentPlay(Engine).bet) + " WOW";
            }else{
                this.ctx.fillStyle = (this.themeWhite? "#edeef0" : "#edeef0");
            }
