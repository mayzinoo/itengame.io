define([
    ...
    return React.createClass({
        ...
        render: function () {
            ...
            var auto_cash_out_amounts = AppConstants.QuickBetAmountButton.AMOUNTS;
            var length = auto_cash_out_amounts.length;
            console.log('autocash-amount');
            console.log(auto_cash_out_amounts);
